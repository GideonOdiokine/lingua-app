...
export const languages: SupportedLanguage[] = [
  {
    ...
    learnerDescription: "A popular beginner language with practical travel use.",
    sampleGreeting: "Hola",
    difficultyNote: "Great for first-time learners because spelling is consistent.",
  ...
  },
  {
    ...
    learnerDescription: "A friendly choice for greetings, food, and everyday chat.",
    sampleGreeting: "Bonjour",
    difficultyNote: "Pronunciation takes practice, but beginner phrases are very useful.",
    defaultLevel: "beginner",
  },
  {
    id: "ja",
    ...
    learnerDescription: "A fun option for polite conversation and common travel phrases.",
    sampleGreeting: "Konnichiwa",
    difficultyNote: "Sentence structure feels new at first, so short guided lessons help.",
    defaultLevel: "beginner",
  },
  {
    id: "ko",
  ...
  },
  {
    ...
    learnerDescription: "A strong choice for travel, study, and clear everyday conversation.",
    sampleGreeting: "Hallo",
    difficultyNote: "Word order shifts a bit, but many beginner words feel familiar.",
    defaultLevel: "beginner",
  },
  {
    id: "zh",
